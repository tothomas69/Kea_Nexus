...
- `_status_chip(is_quarantined)` — Status column in the device table, a pastel
  red "● Quarantined" / green "● Active" pill reading `device_registry.
is_quarantined` directly. Exists because `last_quarantined_at` alone can't
